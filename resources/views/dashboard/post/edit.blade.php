...
@section('content')
    ...
    <form action="{{route('post.update',$post->id)}}" method="post" enctype="multipart/form-data"> {{-- Acá traemos los parámetros de la funcion update del controlador--}}
        ...
        @include('dashboard.post.form',['task'=>'edit']) {{-- Aca importamos la vista form. que es el formulario principal--}}
